    ...
    <div class="card">
        <div class="card-body">
            ...
            while ($mainsql_result = mysqli_fetch_assoc($mainsql)) {
                ...
                ?>
                <li class="card-block">
                    <b><?php echo $mainsql_result['name']; ?></b>
                                ...
                                <div class="menuActions" style="display: flex; justify-content: end;">
                                    <div class="editName" style="margin:auto;">
                                        <button type="button" class="badge bg-primary" data-bs-toggle="modal"
                                            ...
                                            data-submenuid="<?php echo $sub_id; ?>"
                                            data-submenuname="<?php echo htmlspecialchars($sub_sql_result['sub_menu']); ?>">Edit</button>
                                    </div>
                                    ...
                                    <div class="weight" style="margin:auto;">
                                        <input type="number" class="menu_weight" data-submenuid="<?php echo $sub_id; ?>" name="menu_weight" value="<?php echo $weight; ?>"
                                            style="width:40px;">
                                    </div>
                                </div>
                            </li>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        <div class="row">
                            ...
                            <div class="col-sm-12 grid-margin">
                                <label>Page</label>
                                <input type="text" name="page" class="form-control form-control-sm mb-3"
                                    placeholder="like index.php" required>
                            </div>
