...
$allclientsql = mysqli_query($con,"select * from customer where status=1");
while($allclientsql_result = mysqli_fetch_assoc($allclientsql)){
$customer = $allclientsql_result['name'];
    echo '<h6 class="mb-0 text-uppercase">'.$customer.'</h6> <hr />';
if ($customer) {
			...
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div>
						...
						<h4 class="my-1 text-success"><?php echo $panelOffline . ' / ' . $panelOnline; ?> </h4>
