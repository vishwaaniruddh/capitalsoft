            ...
            <table id="alldvrtable" class="table1 table table-bordered">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $recording_from = $row['Recording From'];
                        $recording_to = $row['Recording To'];
                        ...
                        // Get Dvr Data
                        // $dvrsql = mysqli_query($con,"select * from all_dvr_live where ip='".$ip."'");
                        // $dvrsql_result = mysqli_fetch_assoc($dvrsql);
                        // $dvr_status = $dvrsql_result['status'];
                        ...
                        <tr>
                            ...
                            <td><?php echo $recording_from; ?></td>
                            <td><?php echo $recording_to; ?></td>
