...
function getrass($zone, $paramater, $atmid, $con)
{
    ...
    if ($panel_name == 'RASS') {
        $sql = mysqli_query($con, "select $paramater,SCODE from rass where ZONE='" . $zone . "' ");
    }
...
function getSensorName($table, $zone, $alarm, $parameter)
{
    global $con;
    ...
    $statement = "select $parameter from $table where ZONE='" . $zone . "'";
    $query = mysqli_query($con, $statement);
    $result = mysqli_fetch_assoc($query);

    return $result[$parameter] . $alarmMsg;
...
$camssql = "SELECT s.NewPanelID,s.ATMID,s.customer,s.bank,s.SiteAddress,s.city,s.state,s.Panel_Make,a.zone,
a.alerttype,a.createtime,a.receivedtime,a.closedtime,a.status,a.alarm FROM `sites` s, alerts a where s.NewPanelID = a.panelid ";

if ($panelid != '') {
    $camssql .= "and a.panelid = '" . $panelid . "'";
}

$camssql .= " order by a.id,s.sn ASC";
$camssql . "<br>";

$sql = mysqli_query($con, $camssql);
        ...
        <table id="order-listing" class="table">
            ...
            <tbody>
                ...
                while ($sql_result = mysqli_fetch_assoc($sql)) {
                    ...
                    $closure_remark = getSensorName($panel_name, $zoneid, $alarm, 'SensorName');
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo convertDateTimeFormat($alert_received_dt) ?>
